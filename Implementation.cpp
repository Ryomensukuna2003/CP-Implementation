...
// PBDS (Policy-Based Data Structure) with long long type
typedef tree<ll, null_type, less<ll>, rb_tree_tag, tree_order_statistics_node_update> pbds;

// PBDS Functions:
// find_by_order(k): Returns an iterator to the k-th smallest element (0-based index)
// order_of_key(x): Returns the number of elements in the set less than x
// Example:
// pbds s;
// s.insert(10); s.insert(20); s.insert(30);
// cout << *s.find_by_order(1); // Output: 20
// cout << s.order_of_key(25);  // Output: 2
// --------------------------------------------------------------------------------------
